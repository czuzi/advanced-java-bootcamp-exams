...
public class StudentService {
    ...
    public double calculateStudentAverageBySubject(String studentName, String subject) {
        ...
        return calculateAverage(student.getGradesOfSubject(subject));
    }
    ...
    public List<Student> findStudentsWithMoreGradesThan(int amount) {
        List<Student> students = repository.findAllStudents();
        return students.stream()
                .filter(s -> s.countNumberOfGrades() > amount)
                .toList();
    }
}
